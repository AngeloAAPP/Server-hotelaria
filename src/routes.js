...
const roteadorConsultarServicosPendentes = require('./routes/consultarServicosPendentes')
...
routes.use('/consultarServicosPendentes', roteadorConsultarServicosPendentes)
